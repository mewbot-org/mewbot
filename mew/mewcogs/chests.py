...
class Chests(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.CURRENTLY_ACTIVE = ['Munchlax', 'Latias', 'Zarude', 'Articuno-galar', 'Kubfu', 'Magearna', 'Passimian', 'Bruxish', 'Sigilyph', 'Illumise', 'Charcadet', 'Aerodactyl']
    ...
    async def legend(self, ctx):
        ...
        #Voucher
            ...
            msg = (
                ...
                "Message Foreboding (334155028170407949) in Mewbot's Official Server for more information!\n"
            )
        #Redeem            
        elif reward == "redeem":
