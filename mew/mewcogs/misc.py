...
class Misc(commands.Cog):
    ...
    async def donate(self, ctx):
        ...
        donation_url = f"https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=76Y88UVB4R3UN&lc=US&item_name=MewBot-Donation-from-{ctx.author.id}&no_note=1&no_shipping=1&rm=1&currency_code=USD&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHosted&custom={ctx.author.id}&notify_url=http://mewbot.xyz:15211/paypal/"
