...
def draw_pixel_pokemon_card(path, level, gender = '-m'):
    ...
    draw.text( (140, 40), f"Lv.{level}", anchor="mm", fill="black", align = "center", font=font)
    return base_card
...
def draw_player_headers(background, names):
    ...
    rects = draw_rectangle(rect_w, rect_h, "#0000FF"), draw_rectangle(rect_w, rect_h, "#FF0000")
...
@app.post("/build")
def build_image(poke1_image_url: str, poke2_image_url: str, poke1: str, poke2: str, background_number: int, weather: str, trick_room: int):
    """Paramater payload will be like the following
